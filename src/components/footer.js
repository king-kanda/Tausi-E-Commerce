        ...
        <>
            <footer className="bg-smoke">
                ...
                >
                    ...
                    <div>
                        <div className="text">
                            <h3 className={`text-4xl font-Semibold ${roslindale.className} text-red text-start`}>Tausi </h3>
                        </div>

                        <p className={`mt-4 max-w-xs text-gray-500 ${inter.className}`}>
                    ...
                    <div
                        className={`grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4  ${inter.className} `}>
                        <div>
