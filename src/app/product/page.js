                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="flex flex-wrap -mx-4 mb-12">
                        ...
                        <div className="lg:w-112">
                            <a
                            className="relative group block mb-6 h-112 w-full "
                            href="#"
                            >
                            <div className=" h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                <img
                                className="img-fluid w-full h-100 object-cover  border border-gray "
                                src="https://res.cloudinary.com/namiri/image/upload/v1694035779/samples/ecommerce/ca-creative-E1rH__X9SA0-unsplash_q3ivqj.jpg"
                                alt=""
                                />
                            </div>
                            </a>
                        ...
                        <div className="max-w-lg">
                            <h2 className={`text-4xl font-bold mb-1 ${inter.className} `}>Product title</h2>
                            <span className={`block text-sm mb-5 ${inter.className} `}>Brand Name</span>

                            <div className="flex items-center mb-4 text-red">
                            ...
                            <div className={` ${inter.className} `}>
                                ...
                                Pariatur ex aliqua elit ut enim consequat amet non do ut. Ad aute
                                deserunt fugiat qui Lorem in quis velit labore voluptate.
                                </p>
                                <ul className={`list-disc list-inside  mb-6 ${inter.className} `}>
                            ...
                            <div className="w-full sm:w-auto mb-4 sm:mb-0 sm:mr-4">
                                ...
                                <button className="flex w-3.5 h-3.5 px-px items-center justify-center bg-black hover:bg-indigo-500 rounded transition duration-100">
                                    <div className="h-px mx-px w-full bg-white" />
                                </button>
                                <input
                                ...
                                <button className="relative flex w-3.5 h-3.5 px-px py-px items-center justify-center bg-black hover:bg-indigo-500 rounded transition duration-100">
                                    ...
                                    <div className="inline-block max-w-max mx-auto h-full bg-white">
                                        <div className="inline-block px-px" />
                                    </div>
                                    </div>
                                </button>
                                </div>
                            ...
                            <div className="flex-grow-1 w-full px-2 mb-4">
                                <a
                                className="group relative inline-block h-12 w-full -mb-2  "
                                href="#"
                                >
                                <div className="absolute top-0 left-0 transform -translate-y-1 -translate-x-1 w-full h-full group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                    <div className="flex h-full w-full items-center justify-center bg-red  text-smoke">
                                    <span className="text-base font-bold text-smoke">
                                        Add to Cart
                                    </span>
                                    </div>
                                </div>
